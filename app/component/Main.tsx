  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row pt-25 h-screen w-full items-center xl:justify-between lg:items-start bg-gradient-to-b from-white/0 from-10% via-green-400/10 to-white/0">
        ...
        <div className="flex justify-center items-start w-full md:w-[50%] md:justify-start">
          <div className="flex justify-center items-end relative md:h-90 md:w-90 lg:w-130 lg:h-130 h-70 w-70 m-10 mt-10 rounded-[50%] border-6 border-t-green-400 border-b-green-400 border-yellow-500 animate-pulse hover:animate-none">
